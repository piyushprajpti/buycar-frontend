      ...
      <div className={style["container"]}>
         <div className={style["wrapper"]}>
            ...
            <div className={style["buy-car-wrapper"]}>
               ...
               <input 
                  className={style["name-input-field"]}
            ...
            <div className={style["sell-car-wrapper"]}>
               ...
               <ActionButton name={"Sell Car"} leadingIcon={R.ic_sell_car} leadingIconWidth={"24px"} textMargin={"0 0 0 6px"} paddingValues={"22px 0"} width={"100%"} fontSize={"1.5rem"} fontWeight={"500"} margin={"0 0 30px 0"} />
